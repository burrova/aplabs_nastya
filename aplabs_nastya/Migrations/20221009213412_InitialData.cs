    ...
    public partial class InitialData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                table: "Cars",
                columns: new[] { "CarId", "Brand", "Horsepower", "Name", "Price", "Type" },
                values: new object[,]
                {
                    { new Guid("19d4c053-49b6-410c-bc78-2d54a9991870"), "Mitsubishi", 200, "Outlander", 1400000.0, "Vnedorozhnik" },
                    { new Guid("29d4c053-49b6-410c-bc78-2d54a9991870"), "Toyota", 190, "Corolla", 900000.0, "Universal" }
                });

            migrationBuilder.InsertData(
                table: "Clients",
                columns: new[] { "ClientId", "Age", "City", "Name", "Surname" },
                values: new object[,]
                {
                    { new Guid("89d4c053-49b6-410c-bc78-2d54a9991870"), 0, "Sochi", "Nastya", "Burova" },
                    { new Guid("99d4c053-49b6-410c-bc78-2d54a9991870"), 0, "Saransk", "Nastya", "Vlasenkova" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Cars",
                keyColumn: "CarId",
                keyValue: new Guid("19d4c053-49b6-410c-bc78-2d54a9991870"));

            migrationBuilder.DeleteData(
                table: "Cars",
                keyColumn: "CarId",
                keyValue: new Guid("29d4c053-49b6-410c-bc78-2d54a9991870"));

            migrationBuilder.DeleteData(
                table: "Clients",
                keyColumn: "ClientId",
                keyValue: new Guid("89d4c053-49b6-410c-bc78-2d54a9991870"));

            migrationBuilder.DeleteData(
                table: "Clients",
                keyColumn: "ClientId",
                keyValue: new Guid("99d4c053-49b6-410c-bc78-2d54a9991870"));
